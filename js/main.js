...
const chave = document.getElementById('chave').addEventListener('input', cripto);
...
const btnSetkey = document.getElementById('btnSetkey').addEventListener('click', setKey);
